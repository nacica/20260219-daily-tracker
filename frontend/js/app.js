...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260329h";
import { renderInputForm } from "./components/input-form.js?v=20260329h";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260329h";
import { renderHistoryList } from "./components/history-list.js?v=20260329h";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260329h";
import { renderSuggestions } from "./components/suggestions.js?v=20260329h";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260329h";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260329h";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260329h";
import { renderJournal } from "./components/journal.js?v=20260329h";
import { renderBraindump } from "./components/braindump.js?v=20260329h";
import { recordsApi, analysisApi, remindersApi } from "./api.js?v=20260329h";
import { initSwipeNav } from "./swipe-nav.js?v=20260329h";
import { buildTaskStatsCards, renderTaskStats } from "./components/task-stats.js?v=20260329h";
