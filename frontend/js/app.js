...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260412c";
import { renderInputForm } from "./components/input-form.js?v=20260412c";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260412c";
import { renderHistoryList } from "./components/history-list.js?v=20260412c";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260412c";
import { renderSuggestions } from "./components/suggestions.js?v=20260412c";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260412c";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260412c";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260412c";
import { renderJournal } from "./components/journal.js?v=20260412c";
import { renderBraindump } from "./components/braindump.js?v=20260412c";
import { recordsApi, analysisApi, remindersApi } from "./api.js?v=20260412c";
import { initSwipeNav } from "./swipe-nav.js?v=20260412c";
import { buildTaskStatsCards, renderTaskStats } from "./components/task-stats.js?v=20260412c";
import { renderFlashcardList } from "./components/flashcard-list.js?v=20260412c";
import { renderFlashcardStudy } from "./components/flashcard-study.js?v=20260412c";
