...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260308r";
import { renderInputForm } from "./components/input-form.js?v=20260308r";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260308r";
import { renderHistoryList } from "./components/history-list.js?v=20260308r";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260308r";
import { renderSuggestions } from "./components/suggestions.js?v=20260308r";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260308r";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260308r";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260308r";
import { renderJournal } from "./components/journal.js?v=20260308r";
import { recordsApi, analysisApi } from "./api.js?v=20260308r";
import { initSwipeNav } from "./swipe-nav.js?v=20260308r";
