...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260306d";
import { renderInputForm } from "./components/input-form.js?v=20260306d";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260306d";
import { renderHistoryList } from "./components/history-list.js?v=20260306d";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260306d";
import { renderSuggestions } from "./components/suggestions.js?v=20260306d";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260306d";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260306d";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260306d";
import { renderJournal } from "./components/journal.js?v=20260306d";
import { recordsApi, analysisApi } from "./api.js?v=20260306d";
import { initSwipeNav } from "./swipe-nav.js?v=20260306d";
