...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260614c";
import { recordsApi } from "./api.js?v=20260614c";
import { initSwipeNav } from "./swipe-nav.js?v=20260614c";
import { initBedtimeTimer } from "./bedtime-timer.js?v=20260614c";
import { initSidebarResize } from "./sidebar-resize.js?v=20260614c";

// ===== 動的 import ヘルパー =====
// 各コンポーネントは初回訪問時に初めてネットワーク取得（以降は SW キャッシュから即応答）
const loadInputForm       = () => import("./components/input-form.js?v=20260614c");
const loadAnalysisView    = () => import("./components/analysis-view.js?v=20260614c");
const loadHistoryList     = () => import("./components/history-list.js?v=20260614c");
const loadWeeklyReport    = () => import("./components/weekly-report.js?v=20260614c");
const loadSuggestions     = () => import("./components/suggestions.js?v=20260614c");
const loadMonthlyReport   = () => import("./components/monthly-report.js?v=20260614c");
const loadJournal         = () => import("./components/journal.js?v=20260614c");
const loadBraindump       = () => import("./components/braindump.js?v=20260614c");
const loadTaskStats       = () => import("./components/task-stats.js?v=20260614c");
const loadFlashcardList   = () => import("./components/flashcard-list.js?v=20260614c");
const loadFlashcardStudy  = () => import("./components/flashcard-study.js?v=20260614c");
const loadWishlist        = () => import("./components/wishlist.js?v=20260614c");
const loadGratitude       = () => import("./components/gratitude.js?v=20260614c");
const loadUdemyTips       = () => import("./components/udemy-tips.js?v=20260614c");
