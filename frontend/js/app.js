...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260316b";
import { renderInputForm } from "./components/input-form.js?v=20260316b";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260316b";
import { renderHistoryList } from "./components/history-list.js?v=20260316b";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260316b";
import { renderSuggestions } from "./components/suggestions.js?v=20260316b";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260316b";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260316b";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260316b";
import { renderJournal } from "./components/journal.js?v=20260316b";
import { recordsApi, analysisApi } from "./api.js?v=20260316b";
import { initSwipeNav } from "./swipe-nav.js?v=20260316b";
import { buildTaskStatsCards, renderTaskStats } from "./components/task-stats.js?v=20260316b";
