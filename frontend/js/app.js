...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260308p";
import { renderInputForm } from "./components/input-form.js?v=20260308p";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260308p";
import { renderHistoryList } from "./components/history-list.js?v=20260308p";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260308p";
import { renderSuggestions } from "./components/suggestions.js?v=20260308p";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260308p";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260308p";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260308p";
import { renderJournal } from "./components/journal.js?v=20260308p";
import { recordsApi, analysisApi } from "./api.js?v=20260308p";
import { initSwipeNav } from "./swipe-nav.js?v=20260308p";
