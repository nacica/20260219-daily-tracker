...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260323e";
import { renderInputForm } from "./components/input-form.js?v=20260323e";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260323e";
import { renderHistoryList } from "./components/history-list.js?v=20260323e";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260323e";
import { renderSuggestions } from "./components/suggestions.js?v=20260323e";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260323e";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260323e";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260323e";
import { renderJournal } from "./components/journal.js?v=20260323e";
import { recordsApi, analysisApi } from "./api.js?v=20260323e";
import { initSwipeNav } from "./swipe-nav.js?v=20260323e";
import { buildTaskStatsCards, renderTaskStats } from "./components/task-stats.js?v=20260323e";
