...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260820b";
import { recordsApi } from "./api.js?v=20260820b";
import { initSwipeNav } from "./swipe-nav.js?v=20260820b";
import { initSidebarResize } from "./sidebar-resize.js?v=20260820b";
...
const loadInputForm       = () => import("./components/input-form.js?v=20260820b");
const loadAnalysisView    = () => import("./components/analysis-view.js?v=20260820b");
const loadHistoryList     = () => import("./components/history-list.js?v=20260820b");
const loadWeeklyReport    = () => import("./components/weekly-report.js?v=20260820b");
const loadSuggestions     = () => import("./components/suggestions.js?v=20260820b");
const loadMonthlyReport   = () => import("./components/monthly-report.js?v=20260820b");
const loadJournal         = () => import("./components/journal.js?v=20260820b");
const loadBraindump       = () => import("./components/braindump.js?v=20260820b");
const loadTaskStats       = () => import("./components/task-stats.js?v=20260820b");
const loadFlashcardList   = () => import("./components/flashcard-list.js?v=20260820b");
const loadFlashcardStudy  = () => import("./components/flashcard-study.js?v=20260820b");
const loadWishlist        = () => import("./components/wishlist.js?v=20260820b");
const loadGratitude       = () => import("./components/gratitude.js?v=20260820b");
const loadUdemyTips       = () => import("./components/udemy-tips.js?v=20260820b");
const loadMichishirube    = () => import("./components/michishirube.js?v=20260820b");
