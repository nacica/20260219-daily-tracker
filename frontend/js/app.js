...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260306i";
import { renderInputForm } from "./components/input-form.js?v=20260306i";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260306i";
import { renderHistoryList } from "./components/history-list.js?v=20260306i";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260306i";
import { renderSuggestions } from "./components/suggestions.js?v=20260306i";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260306i";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260306i";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260306i";
import { renderJournal } from "./components/journal.js?v=20260306i";
import { recordsApi, analysisApi } from "./api.js?v=20260306i";
import { initSwipeNav } from "./swipe-nav.js?v=20260306i";
