...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260228c";
import { renderInputForm } from "./components/input-form.js?v=20260228c";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260228c";
import { renderHistoryList } from "./components/history-list.js?v=20260228c";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260228c";
import { renderSuggestions } from "./components/suggestions.js?v=20260228c";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260228c";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260228c";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260228c";
import { recordsApi, analysisApi } from "./api.js?v=20260228c";
