...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260719b";
import { recordsApi } from "./api.js?v=20260719b";
import { initSwipeNav } from "./swipe-nav.js?v=20260719b";
import { initBedtimeTimer } from "./bedtime-timer.js?v=20260719b";
import { initSidebarResize } from "./sidebar-resize.js?v=20260719b";
...
const loadInputForm       = () => import("./components/input-form.js?v=20260719b");
const loadAnalysisView    = () => import("./components/analysis-view.js?v=20260719b");
const loadHistoryList     = () => import("./components/history-list.js?v=20260719b");
const loadWeeklyReport    = () => import("./components/weekly-report.js?v=20260719b");
const loadSuggestions     = () => import("./components/suggestions.js?v=20260719b");
const loadMonthlyReport   = () => import("./components/monthly-report.js?v=20260719b");
const loadJournal         = () => import("./components/journal.js?v=20260719b");
const loadBraindump       = () => import("./components/braindump.js?v=20260719b");
const loadTaskStats       = () => import("./components/task-stats.js?v=20260719b");
const loadFlashcardList   = () => import("./components/flashcard-list.js?v=20260719b");
const loadFlashcardStudy  = () => import("./components/flashcard-study.js?v=20260719b");
const loadWishlist        = () => import("./components/wishlist.js?v=20260719b");
const loadGratitude       = () => import("./components/gratitude.js?v=20260719b");
const loadUdemyTips       = () => import("./components/udemy-tips.js?v=20260719b");
