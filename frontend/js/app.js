...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260308q";
import { renderInputForm } from "./components/input-form.js?v=20260308q";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260308q";
import { renderHistoryList } from "./components/history-list.js?v=20260308q";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260308q";
import { renderSuggestions } from "./components/suggestions.js?v=20260308q";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260308q";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260308q";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260308q";
import { renderJournal } from "./components/journal.js?v=20260308q";
import { recordsApi, analysisApi } from "./api.js?v=20260308q";
import { initSwipeNav } from "./swipe-nav.js?v=20260308q";
