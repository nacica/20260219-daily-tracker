...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260328a";
import { renderInputForm } from "./components/input-form.js?v=20260328a";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260328a";
import { renderHistoryList } from "./components/history-list.js?v=20260328a";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260328a";
import { renderSuggestions } from "./components/suggestions.js?v=20260328a";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260328a";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260328a";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260328a";
import { renderJournal } from "./components/journal.js?v=20260328a";
import { renderBraindump } from "./components/braindump.js?v=20260328a";
import { recordsApi, analysisApi, remindersApi } from "./api.js?v=20260328a";
import { initSwipeNav } from "./swipe-nav.js?v=20260328a";
import { buildTaskStatsCards, renderTaskStats } from "./components/task-stats.js?v=20260328a";
