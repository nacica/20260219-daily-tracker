...
import { addRoute, navigate, updateNavActive } from "./router.js?v=20260308e";
import { renderInputForm } from "./components/input-form.js?v=20260308e";
import { renderAnalysisView } from "./components/analysis-view.js?v=20260308e";
import { renderHistoryList } from "./components/history-list.js?v=20260308e";
import { renderWeeklyReport } from "./components/weekly-report.js?v=20260308e";
import { renderSuggestions } from "./components/suggestions.js?v=20260308e";
import { renderCoachingChat } from "./components/coaching-chat.js?v=20260308e";
import { renderKnowledgeGraph } from "./components/knowledge-graph.js?v=20260308e";
import { renderMonthlyReport } from "./components/monthly-report.js?v=20260308e";
import { renderJournal } from "./components/journal.js?v=20260308e";
import { recordsApi, analysisApi } from "./api.js?v=20260308e";
import { initSwipeNav } from "./swipe-nav.js?v=20260308e";
