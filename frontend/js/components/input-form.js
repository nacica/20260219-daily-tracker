...
import { recordsApi, analysisApi, morningDialogueApi } from "../api.js?v=20260315d";
import { showToast } from "../app.js?v=20260315d";
import { showTaskCompleteAnimation, buildTaskStatsCards } from "./task-stats.js?v=20260315d";
