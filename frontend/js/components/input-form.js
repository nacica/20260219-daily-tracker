...
import { recordsApi, analysisApi, morningDialogueApi } from "../api.js?v=20260316b";
import { showToast } from "../app.js?v=20260316b";
import { showTaskCompleteAnimation, buildTaskStatsCards } from "./task-stats.js?v=20260316b";
