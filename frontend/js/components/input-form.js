...
import { recordsApi, analysisApi, morningDialogueApi } from "../api.js?v=20260321b";
import { showToast } from "../app.js?v=20260321b";
import { showTaskCompleteAnimation, buildTaskStatsCards } from "./task-stats.js?v=20260321b";
