...
import { recordsApi, analysisApi, morningDialogueApi } from "../api.js?v=20260323g";
import { showToast } from "../app.js?v=20260323g";
import { showTaskCompleteAnimation, buildTaskStatsCards } from "./task-stats.js?v=20260323g";
