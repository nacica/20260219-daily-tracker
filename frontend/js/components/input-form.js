...
import { recordsApi, analysisApi, morningDialogueApi } from "../api.js?v=20260323d";
import { showToast } from "../app.js?v=20260323d";
import { showTaskCompleteAnimation, buildTaskStatsCards } from "./task-stats.js?v=20260323d";
